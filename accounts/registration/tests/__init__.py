...
from accounts.registration.tests.backends import *
from accounts.registration.tests.forms import *
from accounts.registration.tests.models import *
from accounts.registration.tests.views import *
